...
// exports.checkPhoneEmailAvailability = async (req, res) => {
...
//       userEmailConflict, // 🔕 Commented - Check in User collection
//       // phone ? User.findOne({ contactNumber: phone }) : null,
//       userPhoneConflict, // 🔕 Commented - Check in User collection
//       flatEmailConflict,
//       flatPhoneConflict,
//     ] = await Promise.all([
//       // email ? User.findOne({ email }) : null,
...
//     if (flatEmailConflict /* || userEmailConflict */) {
//       conflicts.push("email");
//     }

//     if (flatPhoneConflict /* || userPhoneConflict */) {
